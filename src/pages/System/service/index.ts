...
const editUser = async (parmas: any) => {
  return http.post(`/api/edit`, { data: parmas })
}
...
const editRole = async (parmas: any) => {
  return http.put(`/api/grole/editRole`, { data: parmas })
}

export {
  createUse, getUseAll, editUser, deleteUser, getGolabListRole,
  createRole, queryRolePage, deleteRole, editRole
}
